namespace NppDB.Comm
{
    public enum ParserMessageType
    {
        ...
        PARSING_ERROR,
        // Common antipatterns
        SELECT_ALL_IN_SELECT_CLAUSE,
        DELETE_STATEMENT_WITHOUT_WHERE_CLAUSE,
        UPDATE_STATEMENT_WITHOUT_WHERE_CLAUSE,
        ORDER_BY_RANDOM_FUNCTION,
        LEADING_WILDCARD_IN_LIKE_EXPRESSION,
        COMPLEX_SELECT_STATEMENT,
        USE_FLOAT_DATA_TYPE,
        MISSING_CONSTRAINTS_IN_CREATE_TABLE,
    }
}